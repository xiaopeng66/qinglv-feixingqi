...
在 GitHub 的 Releases 页面下载 `qinglv-feixingqi-v1.0.0-debug.apk`，传到 Android 设备后打开安装。该文件是调试签名包，Android 可能要求确认允许来自该来源的安装；请仅从本仓库的发行版页面下载。
...
当前首个版本为 `v1.0.0`。具体更新内容见 [CHANGELOG.md](CHANGELOG.md)。
